...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">Email Belum Teregistrasi!! <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span>
            </button></div>');
            //maka akan dikembalikan kehalaman login
            redirect('auth');
        }
    ...
    public function registrasi()
    {
        ...
        //jika statusnya sudah login, maka tidak bisa mengakses halaman registrasi alias dikembalikan ke tampilan user
        if ($this->session->userdata('email')) {
            redirect('user');
        }
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">Registrasi Berhasil!! <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span>
            </button></div>');
            redirect('auth');
        }
    }
