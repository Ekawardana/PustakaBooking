                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#bukuBaruModal">
                            <i class="fas fa-file-alt"></i> Tambah Buku Baru
                        </a>
                                ...
                                foreach ($buku as $b) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('buku/hapusBuku/') . $b['id']; ?>" class="badge badge-danger tombol-hapus">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bukuBaruModalLabel">Tambah Buku Baru</h5>
            ...
            <form action="<?= base_url('buku'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <!-- Input Pengarang -->
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="pengarang" name="pengarang" placeholder="Masukan nama pengarang">
                    </div>

                    <!-- Input Penerbit -->
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="penerbit" name="penerbit" placeholder="Masukan nama penerbit">
                    </div>
